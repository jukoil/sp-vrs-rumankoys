...
void USART3_IRQHandler(void)
{
	...
	{
		volatile uint32_t aSr = USART3->SR;
		volatile uint8_t aDr = USART3->DR;
	}
...
/**
  * @brief  Sends character to usart3, but first checks if usart is free
...
/**
  * @brief  Registers a function which is called when a character is received on usart3
